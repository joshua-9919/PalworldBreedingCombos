...
- [x] itch.io 私密草稿已创建（project `4827906`）；HTML 包、封面和截图已就绪
- [ ] 完成 itch.io 账号邮箱验证后上传素材；切换 Public 仍需最终确认
...
| 11 launch | site-ops-growth-launch | LIVE | Pages、root/www、Plausible、GSC/Bing sitemap 已上线/提交；Pinterest、Product Hunt、GitHub、DEV 技术文章已执行；itch.io 私密草稿待邮箱验证与公开确认；Palworld Wiki 待审核 |
...
- running：无
- waiting：真实自然流量积累；Reddit 版主许可；Palworld Wiki 编辑审核结果（2026-08-02 跟进）；itch.io 邮箱验证与公开确认
- blocked：itch.io 文件上传被账号邮箱未验证阻塞；验证邮件已于 2026-07-26 重新发送

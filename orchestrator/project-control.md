...
- [ ] itch.io 切换 Public 仍需最终确认；当前页面继续保持 Draft
...
| 11 launch | site-ops-growth-launch | LIVE | Pages、root/www、Plausible、GSC/Bing sitemap 已上线/提交；Pinterest、Product Hunt、GitHub、DEV 技术文章已执行；itch.io 私密草稿 QA_PASS、待公开确认；Palworld Wiki 待审核 |
...
- running：无
- waiting：真实自然流量积累；Reddit 版主许可；Palworld Wiki 编辑审核结果（2026-08-02 跟进）；itch.io 公开确认
- blocked：无
